<%-- 
    Document   : wrong_login
    Created on : Oct 30, 2017, 2:57:39 PM
    Author     : Rin
--%>
    ...
    <section class="main-contents">
      ...
      <div class="container">  
                  ...
                  <div class = "content">         
                        ...
                        <h3 class="subtitle">Something went wrong.</h3>                       
                        
                        <p>Your username and/or password is incorrect.</p>
                        
                        <a href ="login_form.jsp"><button class="btn">Try again</button></a>
