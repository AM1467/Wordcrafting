<%-- 
    Document   : play_difficulties
    Created on : Oct 29, 2017, 6:32:13 PM
    Author     : Rin
--%>
    ...
    <section class="main-contents">
      ...
      <div class="container">  
                  ...
                  <div class = "content">         
                        ...
                        <h3 class="subtitle">Choose a difficulty.</h3>                       
                        
                        <form action="Difficulties" method="post"><center>
      
    <br>
    <input type="radio" name="type" value="easy" checked><h4>Easy</h4>
    <br>  
    <br>
    <input type="radio" name="type" value="normal" ><h4>Normal</h4>
    <br>  
    <br>
    <input type="radio" name="type" value="hard" > <h4>Hard </h4>   
    <br>  
    <br><br>
    <button type="submit" value="start" class = "button"> Start </button>
            </center></form> 
