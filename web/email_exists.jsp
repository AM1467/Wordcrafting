<%-- 
    Document   : email_exists
    Created on : Oct 28, 2017, 4:01:50 PM
    Author     : Rin
--%>
  ...
  <div class="parallax2">
    ...
    <section class="main-contents">
      ...
      <div class="container">  
          ...
          <h3 class="subtitle">There is already an account using this email.</h3>
                  
                  <div class = "content">       
              
                        <p><a href="register.jsp">Try again</a> or <a href="login_form.jsp">Login</a></p>
